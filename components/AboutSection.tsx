      ...
      <section id="about" className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-5xl lg:text-6xl font-bold mb-6 bg-gradient-to-r from-[#1B4376] to-[#2090C3] bg-clip-text text-transparent">
                About NovaAxis
              </h2>
              ...
              <p className="text-lg text-[#4B6E8D] mb-6 leading-relaxed">
                We leverage cutting-edge technologies and industry best practices to build scalable, secure, and high-performance digital solutions. Our commitment to excellence and innovation has made us a trusted partner for businesses looking to grow in the digital age.
              </p>
              <div className="grid grid-cols-2 gap-6">
                <div className="group bg-white border border-[#2090C3]/30 p-6 shadow-md hover:shadow-2xl hover:shadow-[#2090C3]/20 hover:border-[#2090C3]/50 transition-all duration-300">
                  <Award className="w-10 h-10 text-[#1B70A3] mb-3 group-hover:scale-110 group-hover:text-[#2090C3] transition-all duration-300" />
                  <h3 className="font-bold text-[#1B4376] text-lg mb-1">Award Winning</h3>
                  <p className="text-sm text-[#4B6E8D]">Recognized excellence</p>
                </div>
                <div className="group bg-white border border-[#2090C3]/30 p-6 shadow-md hover:shadow-2xl hover:shadow-[#2090C3]/20 hover:border-[#2090C3]/50 transition-all duration-300">
                  <Target className="w-10 h-10 text-[#1B70A3] mb-3 group-hover:scale-110 group-hover:text-[#2090C3] transition-all duration-300" />
                  <h3 className="font-bold text-[#1B4376] text-lg mb-1">Client Focused</h3>
                  <p className="text-sm text-[#4B6E8D]">Your success first</p>
                </div>
                <div className="group bg-white border border-[#2090C3]/30 p-6 shadow-md hover:shadow-2xl hover:shadow-[#2090C3]/20 hover:border-[#2090C3]/50 transition-all duration-300">
                  <Lightbulb className="w-10 h-10 text-[#1B70A3] mb-3 group-hover:scale-110 group-hover:text-[#2090C3] transition-all duration-300" />
                  <h3 className="font-bold text-[#1B4376] text-lg mb-1">Innovative Ideas</h3>
                  <p className="text-sm text-[#4B6E8D]">Creative solutions</p>
                </div>
                <div className="group bg-white border border-[#2090C3]/30 p-6 shadow-md hover:shadow-2xl hover:shadow-[#2090C3]/20 hover:border-[#2090C3]/50 transition-all duration-300">
                  <Shield className="w-10 h-10 text-[#1B70A3] mb-3 group-hover:scale-110 group-hover:text-[#2090C3] transition-all duration-300" />
                  <h3 className="font-bold text-[#1B4376] text-lg mb-1">Trusted Partner</h3>
                  <p className="text-sm text-[#4B6E8D]">Reliable & secure</p>
                </div>
              </div>
            </div>
